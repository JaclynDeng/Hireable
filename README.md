...
每个文件都是一个独立可用的"Skill"——复制全文粘贴给任意 AI 工具（Claude / ChatGPT / Gemini 等），再填写文末的空白输入模板，即可获得结构化的、可直接使用的求职输出。
...
| 02 | `02_resume_builder.md` | 基础简历诊断与重建（含 ATS 安全排版与终稿生成） | 做简历 |
| 03 | `03_resume_version.md` | 按岗位大类生成 2-3 个定向投递版本 | 做简历 |
| 04 | `04_jd_analysis.md` | JD 实质化解读、匹配度评估与面试考察点预测 | 投递 |
